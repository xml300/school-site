          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center">
              <NavLink to="/" className="flex-shrink-0 flex items-center gap-2 focus-visible-ring rounded-md">
                <img src="/logo.png" alt="King David School Logo" className="h-20 w-20  object-contain rounded-full mr-2" />
                <span className={`text-xl font-heading font-bold transition-colors ${isTransparentOnDesktop ? 'text-primary-800 dark:text-white' : 'text-white'}`}>King David School</span>
              </NavLink>
            </div>
