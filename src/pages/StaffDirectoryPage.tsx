            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 opacity-0 animate-fadeInUp">
                    ...
                    <p className="mt-4 text-lg text-primary-600 dark:text-slate-300 max-w-3xl mx-auto">
                        Meet the dedicated faculty and staff of King David School in Nigeria.
                    </p>
                </div>
                    ...
                    {filteredStaff.length > 0 ? (
                        filteredStaff.map((staff, index) => (
                            <div key={staff.id} className="opacity-0 animate-fadeInUp" style={{ animationDelay: `${300 + 50 * index}ms`}}>
                                <div className="group text-center bg-white dark:bg-primary-800 rounded-lg shadow-lg hover:shadow-xl dark:hover:shadow-secondary/20 overflow-hidden transform hover:-translate-y-1.5 transition-all duration-300 p-6 flex flex-col h-full min-h-[350px]">
