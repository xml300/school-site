...
const NewsPage: React.FC = () => {
  return (
    <div className="py-12 pt-36 bg-slate-50 dark:bg-primary-900 opacity-0 animate-fadeIn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 opacity-0 animate-fadeInUp">
          ...
          <p className="mt-4 text-lg text-primary-600 dark:text-slate-300 max-w-3xl mx-auto">
            Stay up-to-date with the latest happenings and announcements from King David School, Nigeria.
          </p>
        </div>
       ...
       <div className="opacity-0 animate-fadeInUp" style={{ animationDelay: '850ms'}}>
        <Card
          key={4}
          imageUrl="/SCHOOL%20ACTIVITIES/FRUIT%20DAY%201.jpg"
          title="Fruit Day Celebration: A Healthy Treat!"
          description="Students and staff enjoyed a vibrant Fruit Day, promoting healthy eating habits with a colorful display of nature's candy."
       ...
       <div className="opacity-0 animate-fadeInUp" style={{ animationDelay: '1000ms'}}>
        <Card
          key={5}
          imageUrl="/SCHOOL%20ACTIVITIES/FRUITS%20DAY%202.jpg"
          title="More Fruity Fun on Fruit Day!"
          description="Another successful Fruit Day saw even more participation, with creative fruit displays and delicious, nutritious snacks for everyone."
