...
const Card: React.FC<CardProps> = ({ imageUrl, title, description, footerContent, className = '' }) => {
  return (
    <div className={`group bg-white dark:bg-primary-800 rounded-lg shadow-lg hover:shadow-xl dark:hover:shadow-secondary/20 overflow-hidden transform hover:-translate-y-1.5 transition-all duration-300 flex flex-col ${className}`}>
      {imageUrl && (
