      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-lg font-heading font-semibold text-white tracking-wider uppercase">Northwood High School</h3>
            <p className="mt-4 text-sm italic text-slate-400">"Excellence, Integrity, Community."</p>
            <p className="mt-4 text-sm">123 Education Lane<br />Springfield, USA 12345</p>
            <p className="mt-2 text-sm">Phone: (555) 123-4567</p>
            <p className="mt-1 text-sm">Email: contact@northwood.edu</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#" className="text-sm hover:text-white transition-colors">Parent Portal</a></li>
              <li><a href="#" className="text-sm hover:text-white transition-colors">Calendar</a></li>
              <li><a href="#" className="text-sm hover:text-white transition-colors">Lunch Menu</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 border-t border-primary-700 dark:border-primary-800 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-slate-400">&copy; {new Date().getFullYear()} Northwood High School. All rights reserved.</p>
